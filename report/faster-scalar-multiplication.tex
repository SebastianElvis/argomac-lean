...
Lean also proves the analogous five-mask affine bijection for the public RCB X coefficients.
...
It must also complete the Y, Z, zero-pad, and ciphertext transports.

The complete row repairs the known perfect-correctness failure.
The generic bounded bridge is complete.
The construction still lacks the distributional hop for the RCB zero-pad masks and ciphertext rows.
