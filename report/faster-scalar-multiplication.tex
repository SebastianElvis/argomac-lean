...
The complete 91-row, 10-worker row mean is 3.351 ms.
Its 95 percent interval is 3.334 to 3.369 ms.
The complete row stage is 4.75 times faster than the serial baseline.
...
The protocol \texttt{encode} mean is 68.809 ms.
Its 95 percent interval is 68.722 to 68.904 ms.
The comparable baseline is 81.309 ms.
The complete implementation reduces this time by 15.4 percent.
...
Satisfied component schedules return the requested membership and homogeneous point values.
