...
The 384-bit hash-to-field reducer uses its fixed 48-byte layout and avoids generic slice loops.
...
The complete 91-row, 10-worker row mean is 3.390 ms.
Its 95 percent interval is 3.371 to 3.410 ms.
The complete row stage is 4.70 times faster than the serial baseline.
Direct field-limb XOR lowers the adjacent row mean by 8.7 percent.

The protocol \texttt{encode} mean is 68.830 ms.
Its 95 percent interval is 68.752 to 68.919 ms.
The comparable baseline is 81.309 ms.
The complete implementation reduces this time by 15.3 percent.
