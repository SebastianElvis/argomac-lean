...
The complete 91-row, 10-worker row mean is 3.630 ms.
Its 95 percent interval is 3.599 to 3.664 ms.
The complete row stage is 4.39 times faster than the serial baseline.
The specialized field reduction lowers the row mean by 3.3 percent against its isolated prior commit.

The protocol \texttt{encode} mean is 69.094 ms.
Its 95 percent interval is 68.941 to 69.291 ms.
